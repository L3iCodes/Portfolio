...
export default function ProjectManagement(){
    ...
    const downloadAsJSON = () => {
        ...
        link.href = url;
        link.download = 'temp_project.json';
             ...
             <div className="flex flex-col p-2 border-1 border-accent h-fit rounded-[10px]">
                <div className="flex justify-between">
                    ...
                    <div className="flex gap-3">
                        <Button onClick={() => setOpenAdd(true)} className={'h-fit border-1 border-accent'}>Add Project</Button>
                        <Button onClick={downloadAsJSON} className={'h-fit border-1 border-accent'}>Download JSON</Button>
                    </div>
